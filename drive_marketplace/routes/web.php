...
//    Route::get('/predict-price', function () {
//    return redirect('http://ec2-16-171-19-64.eu-north-1.compute.amazonaws.com');
//    })->name('predict-price');
    Route::get('/predict-price', [PredictionController::class, 'redirectToFlask'])->name('predict-price');
//    Route::post('/predict-price', [PredictionController::class, 'predictPrice'])->name('predict-price');
...
// Backend section start
    ...
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
        ...
        // Testimonial
        Route::resource('/testimonial', 'TestimonilController');
