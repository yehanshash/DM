    ...
    <li class="nav-item">
        ...
        <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Vehicle Options:</h6>
                <a class="collapse-item" href="{{route('user-product.index')}}">Vehicle</a>
                <a class="collapse-item" href="{{route('user-product.create')}}">Add Vehicle</a>
            </div>
        </div>
    </li>
