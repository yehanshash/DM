									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price"><span>Rs. {{number_format($product_detail->price,2)}}</span>
                                                </p>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-building"></i> <strong>Brand:</strong> {{ $product_detail->brand->title }}</p>
                                                    </div>

                                                    <!-- Model -->
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-car"></i> <strong>Model:</strong> {{ $product_detail->model }}</p>
                                                    </div>

                                                    <!-- Mileage -->
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-road"></i> <strong>Mileage:</strong> {{ $product_detail->mileage }} KM</p>
                                                    </div>

                                                    <!-- Year -->
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-calendar"></i> <strong>Year:</strong> {{ $product_detail->year }}</p>
                                                    </div>

                                                    <!-- Fuel Type -->
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-tint"></i> <strong>Fuel Type:</strong> {{ $product_detail->fuel_type }}</p>
                                                    </div>

                                                    <!-- Transmission -->
                                                    <div class="col-md-6 my-2">
                                                        <p class="border-custom"><i class="fa fa-cogs"></i> <strong>Transmission:</strong> {{ $product_detail->transmission }}</p>
                                                    </div>
                                                </div>
...
<!--													</div>-->
													<div class="add-to-cart mt-4">
                                                        <button type="button" class="btn" onclick="window.location.href = 'tel:{{$product_detail->phone_number}}';">Call Seller</button>
...
@push('styles')
	<style>
        ...
        .border-custom {
            border: 2px solid rgb(117, 117, 117); /* Border color */
